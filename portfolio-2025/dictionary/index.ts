  ...
  [languages.espanish]: {
    userProfile: {
      descriptionMessages: [
        ...
        "- Lo que disfruto: Convertir ideas en interfaces que funcionan y se ven bien. Resolver problemas hasta que dejan de serlo.",
        ...
        "- Misión: Misión: Diseñar y desarrollar con propósito. Que la tecnología no solo sea funcional, sino que también tenga carácter.",
